...
class UserProfile(AbstractUser):
    ...
    image = models.ImageField(upload_to="image/%Y/m", default=u"image/default.png", verbose_name='头像')
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(verbose_name=u'验证码类型', choices=(("register", u'注册'), ("forget", u'找回')), max_length=10)
    sendtime = models.DateField(verbose_name=u'发送时间', default=datetime.now)
